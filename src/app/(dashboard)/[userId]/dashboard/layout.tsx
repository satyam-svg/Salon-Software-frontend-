...
export default function DashboardLayout({
  ...
  const [activePlan, setActivePlan] = useState<SubscriptionPackage | null>(null);
  ...
  const isFeatureAllowed = (featureName: string) => {
    ...
    const featureId = featureConfig[featureName as keyof typeof featureConfig]?.featureId;
    return activePlan?.features.includes(featureId);
  };

  const navItems = [
    { icon: <FiBarChart2 className="text-[#b76e79]" />, label: "Dashboard", href: `/${userid}/dashboard/` },
    { icon: <FiCalendar className="text-[#b76e79]" />, label: "Appointments", href: `/${userid}/dashboard/Appointement` },
    { icon: <FiDollarSign className="text-[#b76e79]" />, label: "Finance", href: `/${userid}/dashboard/finance` },
    { icon: <FiUsers className="text-[#b76e79]" />, label: "Clients", href: `/${userid}/dashboard/Clients` },
    { icon: <FiBox className="text-[#b76e79]" />, label: "Inventory", href: `/${userid}/dashboard/inventory` },
    { icon: <FiGitBranch className="text-[#b76e79]" />, label: "Branch", href: `/${userid}/dashboard/branch` },
    { icon: <FiClipboard className="text-[#b76e79]" />, label: "Services", href: `/${userid}/dashboard/service` },
    { icon: <FiStar className="text-[#b76e79]" />, label: "Feedback", href: `/${userid}/dashboard/feedback` },
    { icon: <FiUsers className="text-[#b76e79]" />, label: "Staffs", href: `/${userid}/dashboard/staff` },
    { icon: <FiSettings className="text-[#b76e79]" />, label: "Settings", href: `/${userid}/dashboard/setting` },
  ];
          ...
          >
            <div className="p-6 space-y-6">
              <div className="space-y-4 mt-10">
                {loadingPlan ? (
                  <div className="text-center text-[#7a5a57]">Loading features...</div>
                ) : (
                  navItems.map((item) => {
