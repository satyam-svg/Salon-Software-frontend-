  ...
  const sendOtpRequest = async (email: string) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}api/email/forgot`,
        {
          method: "POST",
          headers: {
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      ...
      const resetResponse = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}api/users/forgetpassword`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      const emailPromise = fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}api/email/reset`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
