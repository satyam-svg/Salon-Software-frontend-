    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          />
          {errors.salonName && <span className="text-red-500 text-sm">This field is required</span>}
        </div>
        ...
        <div>
          <label className="block text-gray-700 mb-2">Salon Photos</label>
          <div className="border-2 border-dashed border-[#e8c4c0] rounded-lg p-8 text-center">
            <input
              type="file"
              multiple
            ...
            >
              <FiUploadCloud className="text-3xl mb-2 text-[#b76e79]" />
              <span className="font-medium">Drag & drop files or click to upload</span>
              <span className="text-sm">Maximum 5 photos (JPEG, PNG)</span>
            </label>
          </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          type="submit"
          className="w-full bg-gradient-to-r from-[#b76e79] to-[#d8a5a5] text-white py-4 rounded-lg font-semibold"
        >
          Save & Continue
        </motion.button>
      </form>
