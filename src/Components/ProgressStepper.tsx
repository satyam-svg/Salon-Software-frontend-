...
import { FiCheck, FiInfo, FiUser, FiClipboard, FiBox } from "react-icons/fi";
...
export const ProgressStepper = ({
  ...
  return (
    <div
      className="max-w-6xl mx-auto py-8 sm:py-16 px-4 sm:px-6 lg:px-8"
              ...
              >
                ...
                <motion.div
                  className={`relative z-10 w-8 h-8 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-sm sm:text-lg font-bold 
                    ...
                    ${
                      isActive
                        ? "bg-white border-2 sm:border-4 border-pink-500 sm:scale-125 scale-110 shadow-lg"
